...
public class CRUD {
	...
	public String DeleteLocalPage(URI pageid, String query) {
	...
	public String UpdateLocalPage(URI pageid, String query) {
		String urlPage = pageid.toString().substring(6);
	...
	public String CreateLocalPage(URI pageid, String query) {
		String urlPage = pageid.toString().substring(6);
		int indexQuery = urlPage.indexOf("?");
		urlPage = urlPage.substring(0, indexQuery);
		String page = "./Root" + urlPage;
	...
	// metodo usato da GET
	public String getLocalPage(URI pageid, String query) {
		String line;
		...
		Gson gson = new GsonBuilder().setVersion(version).create();
		// se file name="" allora non � richiesto un file, quindi metto a null
		...
		for (File file : files) {
			// se � un file ed � quello con il nome richiesto dalla query
			if ((file.isFile())
				...
				// altrimenti se � un file ma non quello richiesto dalla query
			} else if (file.isFile()) {
				...
				// se non � file allora � una directory
